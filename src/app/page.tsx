    ...
    <>
      ...
      <section className="relative h-[85vh] min-h-[500px] flex items-center justify-center">
        <Image
          ...
          alt="The Bleach Green with the Sperrin Mountains"
          fill
      ...
      <section className="relative py-20">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center text-white">
          <h2 className="font-heading text-3xl sm:text-4xl font-bold mb-4">Support Your Club</h2>
          <p className="text-xl text-gray-300 mb-3">Join the Ardmore Weekly Draw</p>
          <p className="text-gray-400 mb-8 max-w-2xl mx-auto">
            Pick your lucky numbers for just £1 each per week. Three prizes drawn every Friday at 7PM. 
            50% goes to winners, 40% directly supports the club.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <span className="text-gold text-sm">500 numbers available · Draws every Friday 7PM</span>
          </div>
        </div>
      </section>
